...
public class BusinessException extends RuntimeException {
    ...
    public List<String> getClefsExternalisations() {return clefsExternalisations;}
    ...
    public boolean isValid() {return clefsExternalisations == null || clefsExternalisations.isEmpty();}
}
